...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            ...
            <h3 class="auth-title" style="color: whitesmoke;">Log In as Admin</h3>
            ...
            <form action="<?php echo base_url() ?>/adminctl/loggingaccount" method="post">
                ...
                <button class="btn btn-primary btn-block btn-lg shadow-lg mt-5">Log in as Admin</button>
            </form>
