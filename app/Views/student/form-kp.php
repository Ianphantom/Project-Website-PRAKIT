...
<div class="page-heading">
    ...
    <section id="basic-horizontal-layouts">
        <div class="row match-height">
            <form action="<?php echo base_url() ?>/studentctl/insertingkp" method="post">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Diisi Jika KP Berkelompok :</h4>
                                <button class="btn btn-primary" onclick="enable()">Tambah Anggota</button>
                                <button class="btn btn-warning" onclick="disable()">Batalkan Tambah Anggota</button>
                            </div>
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <select name="nama2" id="nama2" class="form-control partner">
                                                            <option value="">-</option>
                                                            <?php foreach ($allUser as $partner){ ?>
                                                                <option value="<?php echo $partner['id_siswa'] ?>"><?php echo htmlentities($partner['nama']);?></option>    
                                                            <?php } ?>
                                                        </select>
                                                        <div class="form-control-icon">
                                                            <i class="bi bi-person"></i>
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="number" class="form-control partner" name="nrp2" placeholder="NRP Siswa" id="nrp2">
                                                        <div class="form-control-icon">
                                                            <i class="bi bi-envelope"></i>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="number" class="form-control partner" name="sks2" id="sks2"  placeholder="SKS">
                                                        <div class="form-control-icon">
                                                            <i class="bi bi-phone"></i>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control partner" id="place2" name="alamat2"  placeholder="Place">
                                                        <div class="form-control-icon">
                                                            <i class="bi bi-lock"></i>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="number" id="mobile2" class="form-control partner" name="nomor2" placeholder="Mobile">
                                                        <div class="form-control-icon">
                                                            <i class="bi bi-phone"></i>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-8">
                                                <!-- <div class="form-group has-icon-left"> -->
                                                    <div class="position-relative">
                                                        <select name="doswal2" id="doswal2" class="form-control partner">
                                                            <option value="">-</option>
                                                            <?php foreach ($lectures as $lecture){ ?>
                                                                <option value="<?php echo $lecture->id_dosen ?>"><?php echo htmlentities($lecture->nama);?></option>    
                                                            <?php } ?>
                                            ...
                                            <div class="col-12 d-flex justify-content-center">
                                                <button type="submit" class="btn btn-secondary me-1 mb-1" href="#">Undang Anggota</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
